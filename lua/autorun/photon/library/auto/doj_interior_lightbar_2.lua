...
local name = "DOJ Interior Lightbar 2"
...
COMPONENT.Sections = {
	...
	["doj_lb"] = {
		[1] = {
			{10 , "_1"}, {6,"_1"} , {5, "_2"}, {9, "_2"}
		},
		[2] = { { 7, "_2"}, {8 , "_1"} },

		[3] = {
			{10, "_1"} , {8,"_1"}, {6,"_1"}, {4,"_1"}, {3, "_2"}, {5, "_2"}, {7, "_2"}, {9, "_2"}
		}
	}
}
...
COMPONENT.Patterns = {
	...
	["doj_lb"] = {
		["full"] = {1,1,0,1,1,0,2,0,2,0,3,0,3,0} 
	}
}
...
local name = "DOJ Interior Lightbar 3"
...
COMPONENT.Meta = {
	auto_int_lb = {
		W = 4.1,
		H = 3.1,
		Sprite = "sprites/emv/tdm_charger_front_int",
		Scale = 1,
		WMult = 1.5,
		NoLegacy = true,
		DirAxis = "Up",
