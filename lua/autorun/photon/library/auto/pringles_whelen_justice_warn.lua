...
local name = "Whelen Justice P-Warn"
...
COMPONENT.Sections = {
	...
	["p_code2"] = {
		[1] = {
			{ 2, "_1" }, { 4, "_1" }, { 6, "_1" },{ 12, "_1" }, { 14, "_1" }, { 16, "_1" }
		},
		[2] = {
			{ 3, "_2" }, { 5, "_2" }, { 7, "_2" },{ 13, "_2" }, { 15, "_2" }, { 17, "_2" }
		},	
	},
	["p_code3"] = {
		[1] = { 
			{6, C1}, {2, C1}, {3, C1}, {7, C1}, {13, C1}, {17, C1}, {16, C1}, {12, C1},
		},
		[2] = {
			{8, C2}, {4, C2}, {1, C2}, {5, C2}, {9, C2}, {11, C2}, {15, C2}, {18, C2}, {14, C2}, {10, C2},  
		}
	},
	["p_warn_corner"] = {
		[1] = { {10, C1} },
...
COMPONENT.Patterns = {
	...
	["p_code3"] = {
		["code3"] = {1,1,1,0,1,1,1,0,2,2,2,0,2,2,2,0,1,1,0,1,1,0,2,2,0,1,0,2,0},
		["code4"] = {1,1,0,2,2,0}
	},
	["p_warn_corner"] = { 
		["warn"] = {1},
