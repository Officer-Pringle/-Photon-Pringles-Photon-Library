...
local name = "Pringles DOJ Whelen Liberty II"
...
COMPONENT.Sections = {
	...
	---------------------------------------------------------------------------
	------------------------PRINGLES PHOTON CODE-------------------------------
	---------------------------------------------------------------------------
	["p_liberty_ii_corner"] = {
		[1] = { {5, R} , {7 , R} },
		[2] = { {6, B} , {8, B} },
	},
	["p_liberty_ii_front_driver"] = {
		[1] = { {3, R}, {9, R} },
		[2] = { {1 ,R}, {11, R} },
		[3] = { {15, R}, {13 , R} },
		[4] = { {3 , R}, {1, R}, {9, R} , {11, R},{1, R} , {15, R} , {11, R} , {13 , R} },
		
	},
	["p_liberty_ii_front_passenger"] = {
		[1] = { { 4,B }, {10 , B} },
		[2] = { { 2, B}, {12 , B} },
		[3] = { { 16, B}, {14 , B} },
		[4] = { {16 , B}, {2 , B }, {4 , B}, {14 ,B}, {12 , B}, {10 , B} },
	}
}
...
COMPONENT.Patterns = {
	...
	------------------------------------------------
	["p_liberty_ii_corner"] = {
		["FULL"] = { 2,0,2,0,2,0,2,0,1,0,1,0,1,0,1}
	},
	["p_liberty_ii_front_driver"] = {
		["FULL"] = { 1,2,3,2,1,1,2,3,2,1,1,2,3,2,1,4,4,0,4,4,0,4,4,0,4,4,0,4,4,0,4,4}
	},
	["p_liberty_ii_front_passenger"] = {	
		["FULL"] = { 1,2,3,2,1,1,2,3,2,1,1,2,3,2,1,4,4,0,4,4,0,4,4,0,4,4,0,4,4,0,4,4}
	}
...
COMPONENT.Modes = {
	Primary = {
			M1 = {
				["p_liberty_ii_corner"] = "FULL",
				["p_liberty_ii_front_driver"] = "FULL",
				["p_liberty_ii_front_passenger"] = "FULL"
			},
			M2 = {
				["p_liberty_ii_corner"] = "FULL",
				["p_liberty_ii_front_driver"] = "FULL",
